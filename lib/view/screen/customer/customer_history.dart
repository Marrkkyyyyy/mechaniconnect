...
import 'package:mechaniconnect/controller/customer/customer_history_controller.dart';
...
class CustomerHistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CustomerHistoryController>(builder: (controller) {
                        ...
                        : Column(
                            children: List.generate(
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Get.toNamed(AppRoute.customerHistoryDetails,
                                      arguments: {
